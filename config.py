...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '1758665916:AAF-5I4va4PI-Y_UtIb2luP3PKoThzmV9eU' # Get it from https://t.me/BotFather
    APP_ID = '5770598' # Get it from my.telegram.org/apps
    API_HASH = '40639f24990e3e8443512d14a4744c16' # Get it from my.telegram.org/apps
